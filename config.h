 ...
 */
static const char *fonts[]            = {"MDejaVu Sans Mono for Powerline:size=10:antialias=true:autohint=true",
...
static const char *termcmd[]     = { "st","-e" ,"bicon", NULL };
...
//	{ MODKEY|ShiftMask,        XK_c,    spawn,          CMD("st -e cava |  sleep 0.5s  | st -e bicon -e cmus") },

//	{ MODKEY|Mod1Mask,        XK_e,    spawn,          CMD("st -e emacsclient -c -a emacs") },
 // 	{ MODKEY|ShiftMask,        XK_f,    spawn,          CMD("st -e bicon -e vifm") },
